...
using atlas::seed::DEFAULT_UNSIGNED_INT_SEED;
...
using atlas::seed::RANDOM_HASH_NORMAL_SCALE_FOR_MIX;
using atlas::seed::RANDOM_HASH_PHASE_COEFF_X;
using atlas::seed::RANDOM_HASH_PHASE_COEFF_Y;
using atlas::seed::RANDOM_HASH_PHASE_COEFF_Z;
using atlas::seed::RANDOM_HASH_SALT_DIFFUSE_U1;
using atlas::seed::RANDOM_HASH_SALT_DIFFUSE_U2;
using atlas::seed::RANDOM_HASH_SALT_MIX;
using atlas::seed::RANDOM_HASH_VALUE_SCALE;
