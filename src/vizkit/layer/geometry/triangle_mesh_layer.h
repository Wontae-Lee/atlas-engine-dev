...
namespace atlas::vizkit {
    ...
    protected:
        ...
        void build_geometry(std::vector<Vector3<T>>&pos) override;
    ...
    public:
        ...
        Builder& with_unit(const atlas::UnitHostPtr<T>&u);

        TriangleMeshLayer build() const;

        std::shared_ptr<TriangleMeshLayer> make_shared() const;
