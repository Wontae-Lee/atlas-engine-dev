...
exclusive_scan_host_impl(InputIt first, InputIt last,
    ...
    struct ScanBody {
        ...
        void operator()(const tbb::blocked_range<diff_t>& r, tbb::pre_scan_tag) {
            // ----------------------------------------------------
            // pre_scan phase:
        ...
        void operator()(const tbb::blocked_range<diff_t>& r, tbb::final_scan_tag) {
            // ----------------------------------------------------
            // final_scan phase:
        ...
        void reverse_join(ScanBody& rhs) {
            // ----------------------------------------------------
            // Join phase:
