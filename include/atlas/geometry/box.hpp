#ifndef INCLUDE_ATLAS_GEOMETRY_BOX_HPP
#define INCLUDE_ATLAS_GEOMETRY_BOX_HPP
...
Box<T>::closest_point(const Vector3<T>& point) const {
    ...
    T cx = (point.x < lower_corner.x) ? lower_corner.x : (point.x > upper_corner.x) ? upper_corner.x
                                                                                    : point.x;
    T cy = (point.y < lower_corner.y) ? lower_corner.y : (point.y > upper_corner.y) ? upper_corner.y
                                                                                    : point.y;
    T cz = (point.z < lower_corner.z) ? lower_corner.z : (point.z > upper_corner.z) ? upper_corner.z
                                                                                    : point.z;
...
Box<T>::closest_normal(const Vector3<T>& point) const {
    ...
    const T cx = (point.x < lower_corner.x) ? lower_corner.x : (point.x > upper_corner.x) ? upper_corner.x
                                                                                          : point.x;
    const T cy = (point.y < lower_corner.y) ? lower_corner.y : (point.y > upper_corner.y) ? upper_corner.y
                                                                                          : point.y;
    const T cz = (point.z < lower_corner.z) ? lower_corner.z : (point.z > upper_corner.z) ? upper_corner.z
                                                                                          : point.z;
