#ifndef INCLUDE_ATLAS_MATH_MATRIX_EXPRESSION_H
#define INCLUDE_ATLAS_MATH_MATRIX_EXPRESSION_H
...
public:
    ATLAS_NODISCARD ATLAS_ALL_DEVICE ATLAS_FORCE_INLINE
        std::size_t
        rows() const noexcept { return static_cast<const E&>(*this).rows(); }
    ATLAS_NODISCARD ATLAS_ALL_DEVICE ATLAS_FORCE_INLINE
        std::size_t
        cols() const noexcept { return static_cast<const E&>(*this).cols(); }
    ATLAS_NODISCARD ATLAS_ALL_DEVICE ATLAS_FORCE_INLINE
        std::size_t
        size() const noexcept { return rows() * cols(); }
    ATLAS_NODISCARD ATLAS_ALL_DEVICE ATLAS_FORCE_INLINE
        T
        operator[](std::size_t i) const noexcept { return static_cast<const E&>(*this)[i]; }
    ATLAS_NODISCARD ATLAS_ALL_DEVICE ATLAS_FORCE_INLINE
        T
        operator()(std::size_t r, std::size_t c) const noexcept { return static_cast<const E&>(*this)(r, c); }
...
class MatrixUnaryOperator : public MatrixExpression<T, MatrixUnaryOperator<T, E, Operator>> {
public:
    ...
    ATLAS_NODISCARD ATLAS_ALL_DEVICE ATLAS_FORCE_INLINE
        T
        operator[](std::size_t i) const noexcept { return _op(_e[i]); }
    ATLAS_NODISCARD ATLAS_ALL_DEVICE ATLAS_FORCE_INLINE
        T
        operator()(std::size_t r, std::size_t c) const noexcept { return _op(_e(r, c)); }
...
class MatrixBinaryOperator : public MatrixExpression<T, MatrixBinaryOperator<T, EL, ER, Operator>> {
public:
    ...
    ATLAS_NODISCARD ATLAS_ALL_DEVICE ATLAS_FORCE_INLINE
        T
        operator()(std::size_t r, std::size_t c) const noexcept { return _op(_l(r, c), _r(r, c)); }
...
template <typename T, typename E, typename Operator>
class MatrixScalarRight : public MatrixExpression<T, MatrixScalarRight<T, E, Operator>> {
public:
    ATLAS_ALL_DEVICE ATLAS_FORCE_INLINE
    ...
    ATLAS_NODISCARD ATLAS_ALL_DEVICE ATLAS_FORCE_INLINE
        T
        operator()(std::size_t r, std::size_t c) const noexcept { return _op(_e(r, c), _v); }
...
template <typename T, typename E, typename Operator>
class MatrixScalarLeft : public MatrixExpression<T, MatrixScalarLeft<T, E, Operator>> {
public:
    ATLAS_ALL_DEVICE ATLAS_FORCE_INLINE
    ...
    ATLAS_NODISCARD ATLAS_ALL_DEVICE ATLAS_FORCE_INLINE
        T
        operator[](std::size_t i) const noexcept { return _op(_v, _e[i]); }
    ATLAS_NODISCARD ATLAS_ALL_DEVICE ATLAS_FORCE_INLINE
        T
        operator()(std::size_t r, std::size_t c) const noexcept { return _op(_v, _e(r, c)); }
...
class MatrixSelect : public MatrixExpression<T, MatrixSelect<T, EM, ET, EF>> {
public:
    ATLAS_ALL_DEVICE ATLAS_FORCE_INLINE
    ...
    ATLAS_NODISCARD ATLAS_ALL_DEVICE ATLAS_FORCE_INLINE
        T
        operator()(std::size_t r, std::size_t c) const noexcept { return _m(r, c) ? _t(r, c) : _f(r, c); }
