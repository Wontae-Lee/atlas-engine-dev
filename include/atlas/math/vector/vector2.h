#ifndef INCLUDE_ATLAS_MATH_VECTOR_VECTOR2_H
#define INCLUDE_ATLAS_MATH_VECTOR_VECTOR2_H
...
namespace math {
    ...
    public:
        ...
        set(T s) noexcept;
        template <typename... Args, typename = std::enable_if_t<(sizeof...(Args) == 2) && (std::conjunction_v<std::is_convertible<Args, T>...>)>>
        ATLAS_ALL_DEVICE ATLAS_FORCE_INLINE void
